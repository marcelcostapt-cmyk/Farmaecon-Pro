...
| 4. DNS e HTTPS | Apenas app/api ajustados após leitura atual; TLS, redirecionamento e navegador verificados | DNS A/AAAA propagados e HTTP→HTTPS confirmado; TLS público apresenta certificado autoassinado e IPv6 ainda não verificado; checkpoint 10 |
