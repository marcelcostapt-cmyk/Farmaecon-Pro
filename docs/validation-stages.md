...
Atualizado em 21/09/2026. Cada checkpoint distingue implementação, execução
...
Checkpoint atual: [validação de 21/09/2026](checkpoints/2026-09-21-validation.md).
